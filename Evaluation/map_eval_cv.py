...
if __name__ == '__main__':
    ...
    parser.add_argument('--confidence',      default=0.6,   type=float,  help='Confidence Threshold')
    ...
    parser.add_argument('--out_dir',         default=r'E:\data\testset\didi-result', type=str, help='dir to output MISS-GTBOX and False-Detectbox recorder file')
