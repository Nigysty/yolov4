...
class Inference(object):
    ...
    def __init__(self, **kwargs):
        ...
        self.net = Darknet(self.yolo_cfg)
    ...
    def load_model_pth(self, model, pth):
        ...
        print(model_dict.keys(), pretrained_dict.keys())
    ...
    def detect_image(self, image_src):
        ...
        batch_detections = non_max_suppression(output, len(self.class_names),
                                               ...
                                               nms_thres=0.6)
        boxes = [box.cpu().numpy() for box in batch_detections if box is not None]
        if boxes:
            return boxes[0]
        return []
        #return boxes[0]
...
if __name__ == '__main__':
    params = {
        'cfg_path': 'work_dir/yolo4_train.cfg',
        #'cfg_path': 'work_dir/yolo4_train.cfg',
        "model_path": 'weights/yolo4_citycar_6000_2cls.weights',
        "anchors_path": 'work_dir/citycar_6000_anchors.txt',
    ...
    plot_boxes_cv2(image_src, boxes, savename='output4.jpg', class_names=class_names)